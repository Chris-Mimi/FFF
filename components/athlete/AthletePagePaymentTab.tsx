    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex items-start gap-4">
            <div className={`p-3 rounded-lg ${hasActiveSubscription || hasTrial ? 'bg-green-100' : 'bg-gray-100'}`}>
              <Calendar className={hasActiveSubscription || hasTrial ? 'text-green-600' : 'text-gray-400'} size={24} />
            </div>
            <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Yearly Subscription */}
          <div className="bg-white rounded-xl shadow-sm border-2 border-teal-500 overflow-hidden relative">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600 mb-6">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-green-500" /> 90-day validity
                </li>
                <li className="flex items-center gap-2">
