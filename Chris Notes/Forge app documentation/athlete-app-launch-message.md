# Forge Athlete App — Launch Message

## English Version

**Your training. Tracked. Effortlessly.**

For the past 6 months we've been building something awesome and it's finally here.

The Forge Athlete App is a training companion built specifically for our community — by your coach, not a software company. It connects directly to our daily programming and gives you tools that most boxes can only dream of. No other app or workout software has features like ours.

**Athletes who track their training get better results.** Knowing what you lifted last month, seeing your benchmark times improve, having your progress laid out in front of you — it changes how you train. The Forge Athlete App makes that effortless.

**Here's what it does:**

- **Your scores are already in there** — we've been logging whiteboard results since January. Sign up and you'll see months of your WOD scores, lift records, and benchmark results waiting for you. Your training history, ready to explore from day one.
- **See your progress over time** — track your benchmarks (Fran, Murph, Grace, plus our own Forge originals) on a chart and watch your times drop and your weights climb. That's where the real wins are.
- **Lift records & PR detection** — every barbell lift tracked across 1RM, 3RM, 5RM, and 10RM. The app spots your personal records automatically so you never miss a milestone.
- **Personal records gallery** — all your PRs in one place. Generate branded share cards for Instagram or WhatsApp to celebrate your progress.
- **Achievements & badges** — earn recognition across Strength, Gymnastics, Endurance, and more. Bronze to Platinum — your own journey, your own pace.
- **Workout leaderboards** — see the results from each WOD if you want a bit of friendly competition. But the most important number on the board is your own, compared to last time.
- **Built-in workout timer** — AMRAP, EMOM, Tabata, For Time. No extra app needed.

Class booking stays free for everyone. The athlete features cost less than a coffee a week — and you can **try it free for 30 days**. No commitment, cancel anytime.

Just open the app and see what you've been doing all year. No app store download — it works right in your phone's browser.
...
**Dein Training. Erfasst. Ohne Aufwand.**
