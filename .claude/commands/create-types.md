...
**Your Task:**
Create comprehensive TypeScript interfaces and types for all database entities and data structures in the application.
 ...
 */
export type WorkoutType = 'For Time' | 'AMRAP' | 'EMOM' | 'Chipper' | 'Rounds for Time' | 'Tabata' | 'Interval' | 'Other';
...
**Output File:**
Create or update `/types/database.ts` with all interfaces, properly organized and documented.
