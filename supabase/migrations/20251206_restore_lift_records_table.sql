-- RESTORE: lift_records table only
-- Date: 2025-12-06
-- Issue: lift_records table was dropped by unified movement system migration
-- Solution: Restore just this table
...
-- Indexes
CREATE INDEX idx_lift_records_user_id ON lift_records(user_id);
CREATE INDEX idx_lift_records_lift_name ON lift_records(lift_name);
CREATE INDEX idx_lift_records_date ON lift_records(lift_date DESC);
CREATE INDEX idx_lift_records_user_lift ON lift_records(user_id, lift_name, lift_date DESC);
