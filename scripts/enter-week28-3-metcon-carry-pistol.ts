...
const sessions: { label: string; wod_id: string; date: string; rows: Row[] }[] = [
  {
    ...
    rows: [
      ...
      { name: 'Valerie Mesenburg',member_id: 'b5d92ef5-251f-42be-b1e2-be9a8925f7f5', ski: 47, row: 61, reps: 32, sc: 'Sc1', note: '5kg' },
      { name: 'Lukas Simnacher',  member_id: 'bde3c76b-24af-44b7-b23d-dc96fbce8b94', ski: 68, row: 101, reps: 16, sc: 'Sc1', note: '5kg' },
      ...
      { name: 'Paul Bielenski',   member_id: '4beb1c91-d4cc-49b6-a34a-87029de73fe5', ski: 75, row: 81, reps: 20, sc: 'Sc2', note: 'on plate, 5kg' },
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'Christian Tanner',   member_id: '5f992b82-f3d0-4373-8817-d344857af7b8', ski: 51, row: 76, reps: 28, sc: 'Sc2', note: 'on plates+5kg' },
      ...
      { name: 'Thomas Spegele',     member_id: '4996f0d3-c46e-4573-b44e-82e46213250e', ski: 56, row: 86, reps: 16, sc: 'Sc2', note: 'on plates+5kg' },
      { name: 'Tobias Götte',       member_id: '9924ac29-5601-4aee-a679-3bb0bd5b1aa2', ski: 63, row: 66, reps: 62, sc: 'Rx' },
      { name: 'Bodo Lehmann',       member_id: '3041b1b3-9e33-43ee-81c7-56896fe50b80', ski: 57, row: 58, reps: 35, sc: 'Sc3', note: 'on platform +5kg, !' },
