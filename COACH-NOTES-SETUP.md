...
**IMPORTANT:** Before using the Coach Notes feature, you must run the SQL migration in Supabase.
...
- Creates full-text search indexes on `coach_notes` and `title` for fast searchability
...
This prepares the system for a WOD search feature that will let you find workouts by any field and drag-drop them into the calendar.
...
These notes are **private** and will help you quickly find and reference workouts in the future.
